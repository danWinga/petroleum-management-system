...
@ManagedBean(name="editfacility")
@SessionScoped
public class EditFacility implements Serializable {
        ...
        public EditFacility(){
            ...
            //System.out.println(httpSession.getAttribute("editfacilityId").toString());
        
            //String query = "SELECT facility_id, district_id, stakeholder_id, facility_level_id, district_name, stakename, level_name, facility_code, facility_name, location, sublocation, details FROM vw_facilities WHERE facility_id = "+ Integer.parseInt(facilityEditId.trim()) +";";
            //String query = "SELECT * FROM vw_facilities WHERE facility_id = "+ Integer.parseInt(facilityEditId.trim()) +";";
            String query = "SELECT * FROM vw_facilities WHERE facility_id = 12577;";
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    sublocation = rs.getString("sublocation");
                    facilityLevelId = rs.getString("facility_level_id"); 
                    stakeholderId = rs.getString("stakeholder_id");
        ...
        public String getFacilityLevelId(){ return facilityLevelId; }
        public String getFacilityTypeId(){ return facilityTypeId; }
        public String getFacilityCode(){ return facilityCode; }
        public String getFacilityName(){ return facilityName; }
        public String getFacilityLocation(){ return location; }
        public String getFacilitySubLocation(){ return sublocation; }
        public String getDetails(){ return details; }

        public void setFacilityId(String facilityId){ this.facilityId = facilityId; }
        public void setDistrictId(String districtId){ this.districtId = districtId; }
        public void setStakeholderId(String stakeholderId){ this.stakeholderId = stakeholderId; }
        public void setFacilityLevelId(String facilityLevelId){ this.facilityLevelId = facilityLevelId; }
        public void setFacilityTypeId(String facilityTypeId){ this.facilityTypeId = facilityTypeId; }
        public void setFacilityCode(String facilityCode){ this.facilityCode = facilityCode; }
        public void setFacilityName(String facilityName){ this.facilityName = facilityName; }
        public void setFacilityLocation(String location){ this.location = location; }
        public void setFacilitySubLocation(String sublocation){ this.sublocation = sublocation; }
...
/*        public String saveData(){
                ...
                String mysql = "UPDATE facilities SET district_id = "+ disId +", stakeholder_id = "+ stakeId +", facility_level_id = "+ levelId +", location = '"+ getFacilityLocation() +"', sublocation = '"+ getFacilitySubLocation() +"', details = '"+ getDetails() +"' WHERE facility_id = "+ Integer.parseInt(facilityEditId.trim()) +";";

                
                
//                String mysql = "UPDATE facilities SET district_id, stakeholder_id, facility_level_id, facility_code, facility_name, location, sublocation, details) VALUES ("+ disId +", "+ stakeId +", "+ levelId +", '"+ getFacilityCode() +"', '"+  getFacilityName() +"', '"+ getFacilityLocation() +"', '"+ getFacilitySubLocation() +"', '"+ getDetails() +"');";

                System.out.println("Edit Facility SQL:"+ mysql);
